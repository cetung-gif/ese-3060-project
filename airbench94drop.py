...
def main(run):
    ...
    for epoch in range(ceil(epochs)):
        ...
        history["epoch_wall_time"].append(epoch_wall_time)
    ...
    return {
        ...
        "total_gpu_time": total_time_seconds,
    }
...
if __name__ == "__main__":
    ...
    accs = torch.tensor([r["tta_val_acc"] for r in results])
    histories = [r["history"] for r in results]
    seeds = [r["seed"] for r in results]
    gpu_times = [r["total_gpu_time"] for r in results]
    wall_times = [r["total_wall_time"] for r in results]
